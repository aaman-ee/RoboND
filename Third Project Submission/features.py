...
def compute_normal_histograms(normal_cloud):
    ...
    norm_x = np.histogram(norm_x_vals, bins=32, range=(-1.0, 1.0))
    norm_y = np.histogram(norm_y_vals, bins=32, range=(-1.0, 1.0))
    norm_z = np.histogram(norm_z_vals, bins=32, range=(-1.0, 1.0))
